...
<c:if test="${not empty admin}">
	<jsp:forward page="/AdminServlet">
		...
		<jsp:param name="username" value="${admin.username}"/>
		<jsp:param name="password" value="${admin.password}"/>
	</jsp:forward>
</c:if>
...
<div class="simple-page-wrap">
	...
	<div class="simple-page-form" id="login-form">
		<h4 class="form-title m-b-xl text-center"><c:out value="${adminMsg}">请输入用户名和密码</c:out></h4>
